...
if __name__ == "__main__":
    ...
    parser.add_argument('--test', action='store', dest='testFile',
                    help='File to test on', default='dev-data.txt') #test-data-no-oov.txt
#    parser.add_argument('--model', action='store', dest='model',
#                    help='What model to use', default='unigram.Unigram')
    parser.add_argument('--model', action='store', dest='model',
                    help='What model to use', default='bigram.Bigram') #unigram.Unigram, bigram.Bigram, bigram_add_k.BigramAddK, bigram_interpolation.BigramInterpolation
    
    parser.add_argument('--showguesses', action='store', dest='showguesses',
                    help='show what you guess', default='False')  #change to true if you want to print the sentences
