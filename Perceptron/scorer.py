...
if __name__ == '__main__':
    ...
    gold_file = "./dev/ptb_22.tagged"
    auto_file = "dev_output.tagged"
    avg_auto_file = "avg_dev_output.tagged"
    print('POS tagging accurarcy: {:.2f}'.format(compute_acc(gold_file, auto_file)))
    print('averaged POS tagging accurarcy: {:.2f}'.format(compute_acc(gold_file, avg_auto_file)))
